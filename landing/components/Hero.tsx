      ...
      <div className="mx-auto max-w-6xl">
        ...
        >
          ...
          <p className="mx-auto mt-5 max-w-xl text-balance text-lg leading-relaxed text-neutral-400 sm:text-xl">
            ContextVault captures LLM chats, coding-agent sessions, decisions, tasks, and project context.
            Everything stays local and exports as clean Markdown or ZIP.
          </p>
